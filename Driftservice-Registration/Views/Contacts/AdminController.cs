...
namespace Driftservice_Registration.Views.Contacts
{
    public class ContactsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "ContactID,FirstName,LastName,Business,Email,PhoneNumber,NotificationType,ContactGuid,Language,RegDate")] Contact contact)
        {
